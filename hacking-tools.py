...
os.system("clear")
print("""Warning:Use this tool for educational purposes only
...
def loop():
  ...
  """)
  print("LogIn to hacking tool")
  uname = input("Username: ")
  pwd = input("Password: ")
  print("Checking Username and password...")
  t.sleep(5)
  if uname != "Hacking Tools" and pwd != "Termuxhackz Society":
    print("Incorrect Username or Password!")
    t.sleep(3)
    os.system("xdg-open https://github.com/spider863644/HAcking-Tools")
    loop()
  
  else:
    print("You have sucessfully logged in to hacking tool")
  t.sleep(5)
loop()
print("<<<<<<>>>>>>>>>>Tools to Run<<<<<<<<<>>>>>")
print("""
...
if c == "1":
  ...
  print("""[1]Target CCTV Hack
  [2]Random CCTV Hack""")
  c3 = input("Choose a valid one: ")
  os.system("figlet HAcking-Tools")
  if c3 == "1":
    os.system("""apt update
    apt install pip2
  ...
  [8]Osint-Framework
  """)
  c4 = input("Choose an option: ")
  os.system("""clear
  figlet Hacking-Tools
  """)
  if c4 == "1":
    os.system("""
    apt update
    ...
    clear""")
    print("""Note:Phone-number-tracker logins are below coz u will be ask
    Tool Name:tracker
    password:g0sain
    ...
    t.sleep(3)
    os.system("xdg-0pen https://osintframework.com")
    loop()
elif c == "4":
  os.system("""apt update
